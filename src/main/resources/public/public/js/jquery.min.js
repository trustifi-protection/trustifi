!function(e, t) {
    ...
    function i(e, n, r, i) {
        if (se.acceptData(e)) {
            ...
            if (f && c[f] && (i || c[f].data) || !u || r !== t)
                return f || (l ? e[s] = f = K.pop() || se.guid++ : f = s),
                c[f] || (c[f] = {},
        ...
        if (se.acceptData(e)) {
            ...
            if (u[l]) {
                if (t && (r = n ? u[l] : u[l].data)) {
                    se.isArray(t) ? t = t.concat(se.map(t, se.camelCase)) : t in r ? t = [t] : (t = se.camelCase(t),
                    t = t in r ? [t] : t.split(" "));
                    for (i = 0,
                    o = t.length; o > i; i++)
                        delete r[t[i]];
                    if (!(n ? s : se.isEmptyObject)(r))
                        return
                }
                (n || (delete u[l].data,
    ...
    function a(e, n, r) {
        if (r === t && 1 === e.nodeType) {
            ...
            "string" == typeof r) {
                try {
                    r = "true" === r || "false" !== r && ("null" === r ? null : +r + "" === r ? +r : we.test(r) ? se.parseJSON(r) : r)
                } catch (o) {}
                se.data(e, n, r)
            } else
                r = t
    ...
    function v(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            !se.support.noCloneEvent && t[se.expando]) {
                r = se._data(t);
                for (i in r.events)
                    se.removeEvent(t, i, r.handle);
                t.removeAttribute(se.expando)
            }
            "script" === n && t.text !== e.text ? (h(t).text = e.text,
            g(t)) : "object" === n ? (t.parentNode && (t.outerHTML = e.outerHTML),
            se.support.html5Clone && e.innerHTML && !se.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && Ze.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
    ...
    function N(e, t) {
        for (var n, r = [], i = 0, o = e.length; o > i; i++)
            n = e[i],
            n.style && (r[i] = se._data(n, "olddisplay"),
            t ? (r[i] || "none" !== n.style.display || (n.style.display = ""),
            "" === n.style.display && w(n) && (r[i] = se._data(n, "olddisplay", S(n.nodeName)))) : r[i] || w(n) || se._data(n, "olddisplay", se.css(n, "display")));
        for (i = 0; o > i; i++)
            n = e[i],
    ...
    function S(e) {
        var t = V
          , n = vt[e];
        return n || (n = A(e, t),
        "none" !== n && n || (lt = (lt || se("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement),
    ...
    function B(e, t) {
        se.each(t, function(t, n) {
            for (var r = (nn[t] || []).concat(nn["*"]), i = 0, o = r.length; o > i; i++)
                if (r[i].call(e, t, n))
                    return
        })
    }
    function P(e, t, n) {
        var r, i, o = 0, a = tn.length, s = se.Deferred().always(function() {
            ...
            if (i)
                return !1;
            for (var t = Gt || O(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; u > a; a++)
                l.tweens[a].run(o);
    ...
    function W(e, t, n) {
        ...
        se.support.shrinkWrapBlocks || p.done(function() {
    ...
    var X, U, V = e.document, Y = e.location, J = e.jQuery, G = e.$, Q = {}, K = [], Z = "1.9.0", ee = K.concat, te = K.push, ne = K.slice, re = K.indexOf, ie = Q.toString, oe = Q.hasOwnProperty, ae = Z.trim, se = function(e, t) {
        ...
        V.addEventListener ? (V.removeEventListener("DOMContentLoaded", xe, !1),
        se.ready()) : "complete" === V.readyState && (V.detachEvent("onreadystatechange", xe),
        se.ready())
    };
    se.fn = se.prototype = {
        jquery: Z,
        ...
        init: function(e, n, r) {
            ...
            if ("string" == typeof e) {
                ...
                if (i[1]) {
                    ...
                    se.merge(this, se.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : V, !0)),
        ...
        --u); l > u; u++)
            if (null != (e = arguments[u]))
                for (n in e)
                    r = s[n],
                    i = e[n],
                    s !== i && (c && i && (se.isPlainObject(i) || (o = se.isArray(i))) ? (o ? (o = !1,
                    a = r && se.isArray(r) ? r : []) : a = r && se.isPlainObject(r) ? r : {},
    ...
    se.extend({
        ...
        ready: function(e) {
            if (e === !0 ? !--se.readyWait : !se.isReady) {
                ...
                se.isReady = !0,
                e !== !0 && --se.readyWait > 0 || (U.resolveWith(V, [se]),
        ...
        parseJSON: function(n) {
            return e.JSON && e.JSON.parse ? e.JSON.parse(n) : null === n ? n : "string" == typeof n && (n = se.trim(n),
            n && de.test(n.replace(ge, "@").replace(me, "]").replace(he, ""))) ? Function("return " + n)() : (se.error("Invalid JSON: " + n),
            t)
        },
        parseXML: function(n) {
            var r, i;
        ...
        proxy: function(e, n) {
            ...
            n = e,
            e = r),
            se.isFunction(e) ? (i = ne.call(arguments, 2),
            o = function() {
        ...
        var n, i, o, a, s, u, l = [], c = !e.once && [], f = function(t) {
            ...
            remove: function() {
                return l && se.each(arguments, function(e, t) {
                    for (var n; (n = se.inArray(t, l, n)) > -1; )
                        l.splice(n, 1),
                        o && (s >= n && s--,
                        u >= n && u--)
                }),
            ...
            if (e === t) {
                ...
                1 === o.nodeType && !se._data(o, "parsedAttrs"))) {
                    for (r = o.attributes; r.length > s; s++)
                        i = r[s].name,
                        i.indexOf("data-") || (i = se.camelCase(i.substring(5)),
                        a(o, i, u[i]));
    ...
    se.extend({
        queue: function(e, n, r) {
            ...
            i = se._data(e, n),
            r && (!i || se.isArray(r) ? i = se._data(e, n, se.makeArray(r)) : i.push(r)),
            i || []) : t
        },
    ...
    se.fn.extend({
        queue: function(e, n) {
            ...
            e = "fx",
            r--),
            r > arguments.length ? se.queue(this[0], e) : n === t ? this : this.each(function() {
    ...
    var Ce, ke, Ee = /[\t\r\n]/g, Se = /\r/g, Ae = /^(?:input|select|textarea|button|object)$/i, je = /^(?:a|area)$/i, De = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i, Le = /^(?:checked|selected)$/i, He = se.support.getSetAttribute, Me = se.support.input;
    se.fn.extend({
        attr: function(e, t) {
        ...
        addClass: function(e) {
            ...
            if (u)
                for (t = (e || "").match(le) || []; s > a; a++)
                    if (n = this[a],
                    r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Ee, " ") : " ")) {
                        for (o = 0; i = t[o++]; )
                            0 > r.indexOf(" " + i + " ") && (r += i + " ");
        ...
        toggleClass: function(e, t) {
            ...
            return se.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    ("undefined" === n || "boolean" === n) && (this.className && se._data(this, "__className__", this.className),
        ...
        val: function(e) {
            var n, r, i, o = this[0];
            return arguments.length ? (i = se.isFunction(e),
            this.each(function(r) {
                ...
                n = se.valHooks[this.type] || se.valHooks[this.nodeName.toLowerCase()],
                n && "set"in n && n.set(this, o, "value") !== t || (this.value = o))
            })) : o ? (n = se.valHooks[o.type] || se.valHooks[o.nodeName.toLowerCase()],
            n && "get"in n && (r = n.get(o, "value")) !== t ? r : (r = o.value,
            "string" == typeof r ? r.replace(Se, "") : null == r ? "" : r)) : void 0
        }
    }),
    se.extend({
        valHooks: {
        ...
        attr: function(e, n, r) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s)
                return e.getAttribute === t ? se.prop(e, n, r) : (a = 1 !== s || !se.isXMLDoc(e),
                a && (n = n.toLowerCase(),
                o = se.attrHooks[n] || (De.test(n) ? ke : Ce)),
    ...
    Me && He || (se.attrHooks.value = {
        ...
        set: function(e, n, r) {
            return se.nodeName(e, "input") ? (e.defaultValue = n,
            t) : Ce && Ce.set(e, n, r)
        }
    }),
    ...
    se.event = {
        ...
        add: function(e, n, r, i, o) {
            ...
            if (y) {
                ...
                (s = y.handle) || (s = y.handle = function(e) {
                    return se === t || e && se.event.triggered === e.type ? t : se.event.dispatch.apply(s.elem, arguments)
                }
                ,
                s.elem = e),
                n = (n || "").match(le) || [""],
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (m && (u = m.events)) {
                ...
                se.isEmptyObject(u) && (delete m.handle,
        ...
        trigger: function(n, r, i, o) {
            ...
            if (s = u = i = i || V,
            3 !== i.nodeType && 8 !== i.nodeType && !Oe.test(h + se.event.triggered) && (h.indexOf(".") >= 0 && (g = h.split("."),
            h = g.shift(),
            g.sort()),
            c = 0 > h.indexOf(":") && "on" + h,
            ...
            o || !p.trigger || p.trigger.apply(i, r) !== !1)) {
                if (!o && !p.noBubble && !se.isWindow(i)) {
                    ...
                    Oe.test(l + h) || (s = s.parentNode); s; s = s.parentNode)
                        d.push(s),
                        u = s;
                ...
                if (n.type = h,
                !(o || n.isDefaultPrevented() || p._default && p._default.apply(i.ownerDocument, r) !== !1 || "click" === h && se.nodeName(i, "a") || !se.acceptData(i) || !c || !i[h] || se.isWindow(i))) {
                    u = i[c],
                    u && (i[c] = null),
            ...
            !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                ...
                n = 0; (o = s[n++]) && !e.isPropagationStopped(); )
                    ...
                    r = 0; (a = o.handlers[r++]) && !e.isImmediatePropagationStopped(); )
                        ...
                        e.data = a.data,
                        i = ((se.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, u),
        ...
        fix: function(e) {
            if (e[se.expando])
                return e;
            var t, n, r = e, i = se.event.fixHooks[e.type] || {}, o = i.props ? this.props.concat(i.props) : this.props;
            for (e = new se.Event(r),
            t = o.length; t--; )
                n = o[t],
                e[n] = r[n];
    ...
    se.support.submitBubbles || (se.event.special.submit = {
        ...
        teardown: function() {
            return !se.nodeName(this, "form") && (se.event.remove(this, "._submit"),
            t)
        }
    }),
    se.support.changeBubbles || (se.event.special.change = {
        setup: function() {
            return qe.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (se.event.add(this, "propertychange._change", function(e) {
            ...
            !1) : (se.event.add(this, "beforeactivate._change", function(e) {
                var t = e.target;
                qe.test(t.nodeName) && !se._data(t, "changeBubbles") && (se.event.add(t, "change._change", function(e) {
    ...
    function(e, t) {
        ...
        function f(e, t) {
            ...
            u = [],
            l = C.preFilter; s; ) {
                (!n || (r = ue.exec(s))) && (r && (s = s.slice(r[0].length) || s),
                u.push(i = [])),
                n = !1,
                (r = le.exec(s)) && (n = r.shift(),
                i.push({
                    value: n,
                    type: r[0].replace(ae, " ")
                }),
                s = s.slice(n.length));
                for (o in C.filter)
                    !(r = pe[o].exec(s)) || l[o] && !(r = l[o](r)) || (n = r.shift(),
                    i.push({
                        value: n,
                        type: o,
                        matches: r
        ...
        function x(e, t, n, r) {
            ...
            if (!r && 1 === l.length) {
                ...
                o.length > 2 && "ID" === (a = o[0]).type && 9 === t.nodeType && !M && C.relative[o[1].type]) {
                    if (t = C.find.ID(a.matches[0].replace(xe, Te), t)[0],
                    !t)
                        return n;
                    e = e.slice(o.shift().value.length)
                }
                for (i = pe.needsContext.test(e) ? -1 : o.length - 1; i >= 0 && (a = o[i],
        ...
        C = a.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[5] && e[2];
                    return pe.CHILD.test(e[0]) ? null : (e[4] ? e[2] = e[4] : n && ce.test(n) && (t = f(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(e, t, n) {
                    return function(r) {
                        var i = a.attr(r, e);
                        return null == i ? "!=" === t : !t || (i += "",
                        "=" === t ? i === n : "!=" === t ? i !== n : "^=" === t ? n && 0 === i.indexOf(n) : "*=" === t ? n && i.indexOf(n) > -1 : "$=" === t ? n && i.substr(i.length - n.length) === n : "~=" === t ? (" " + i + " ").indexOf(n) > -1 : "|=" === t && (i === n || i.substr(0, n.length + 1) === n + "-"))
                    }
                },
    ...
    se.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, r = 0, i = this.length, o = [], a = $e.test(e) || "string" != typeof e ? se(e, t || this.context) : 0; i > r; r++)
    ...
    se.fn.extend({
        ...
        replaceWith: function(e) {
            ...
            this.domManip([e], !0, function(e) {
                var t = this.nextSibling
                  , n = this.parentNode;
                (n && 1 === this.nodeType || 11 === this.nodeType) && (se(this).remove(),
        ...
        domManip: function(e, n, r) {
            ...
            if (v || !(1 >= f || "string" != typeof y || se.support.checkClone) && et.test(y))
                return this.each(function(i) {
                    var o = p.eq(i);
                    v && (e[0] = y.call(this, i, n ? o.html() : t)),
                    o.domManip(e, n, r)
                });
            if (f && (i = se.buildFragment(e, this[0].ownerDocument, !1, this),
            o = i.firstChild,
            1 === i.childNodes.length && (i = o),
            o)) {
                for (n = n && se.nodeName(o, "tr"),
                a = se.map(b(i, "script"), h),
                s = a.length; f > c; c++)
                    u = i,
                    c !== m && (u = se.clone(u, !0, !0),
                    s && se.merge(a, b(u, "script"))),
    ...
    se.each({
        ...
        se.fn[e] = function(e) {
            for (var n, r = 0, i = [], o = se(e), a = o.length - 1; a >= r; r++)
    ...
    se.extend({
        clone: function(e, t, n) {
            ...
            if (se.support.html5Clone || se.isXMLDoc(e) || !Ue.test("<" + e.nodeName + ">") ? s = e.cloneNode(!0) : (at.innerHTML = e.outerHTML,
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, u, l, c, f = e.length, d = p(t), h = [], g = 0; f > g; g++)
                ...
                o || 0 === o)
                    if ("object" === se.type(o))
                        ...
                        c = u[0]; c--; )
                            s = s.lastChild;
                        if (!se.support.leadingWhitespace && Ve.test(o) && h.push(t.createTextNode(Ve.exec(o)[0])),
                        !se.support.tbody)
                            for (o = "table" !== a || Ge.test(o) ? "<table>" !== u[1] || Ge.test(o) ? 0 : s : s.firstChild,
                            c = o && o.childNodes.length; c--; )
                                se.nodeName(l = o.childNodes[c], "tbody") && !l.childNodes.length && o.removeChild(l);
            ...
            g = 0; o = h[g++]; )
                if ((!r || -1 === se.inArray(o, r)) && (i = se.contains(o.ownerDocument, o),
        ...
        cleanData: function(e, n) {
            for (var r, i, o, a, s = 0, u = se.expando, l = se.cache, c = se.support.deleteExpando, f = se.event.special; null != (o = e[s]); s++)
                if ((n || se.acceptData(o)) && (i = o[u],
                r = i && l[i])) {
                    if (r.events)
                        for (a in r.events)
                            f[a] ? se.event.remove(o, a) : se.removeEvent(o, a, r.handle);
                    l[i] && (delete l[i],
    ...
    var st, ut, lt, ct = /alpha\([^)]*\)/i, ft = /opacity\s*=\s*([^)]*)/, pt = /^(top|right|bottom|left)$/, dt = /^(none|table(?!-c[ea]).+)/, ht = /^margin/, gt = RegExp("^(" + ue + ")(.*)$", "i"), mt = RegExp("^(" + ue + ")(?!px)[a-z%]+$", "i"), yt = RegExp("^([+-])=(" + ue + ")", "i"), vt = {
        BODY: "block"
    }, bt = {
        position: "absolute",
        visibility: "hidden",
    ...
    se.extend({
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (n = se.cssProps[u] || (se.cssProps[u] = T(l, u)),
                s = se.cssHooks[n] || se.cssHooks[u],
                r === t)
                    return s && "get"in s && (o = s.get(e, !1, i)) !== t ? o : l[n];
                if (a = typeof r,
                "string" === a && (o = yt.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(se.css(e, n)),
                a = "number"),
        ...
        css: function(e, n, r, i) {
            ...
            return n = se.cssProps[u] || (se.cssProps[u] = T(e.style, u)),
            s = se.cssHooks[n] || se.cssHooks[u],
            s && "get"in s && (o = s.get(e, !0, r)),
            o === t && (o = st(e, n, i)),
            "normal" === o && n in xt && (o = xt[n]),
            r ? (a = parseFloat(o),
            r === !0 || se.isNumeric(a) ? a || 0 : o) : o
        },
    ...
    se.each(["height", "width"], function(e, n) {
        se.cssHooks[n] = {
            ...
            set: function(e, t, r) {
                var i = r && ut(e);
                return C(e, t, r ? k(e, n, r, se.support.boxSizing && "border-box" === se.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
    }),
    se.support.opacity || (se.cssHooks.opacity = {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1,
            (t >= 1 || "" === t) && "" === se.trim(o.replace(ct, "")) && n.removeAttribute && (n.removeAttribute("filter"),
    ...
    se(function() {
        ...
        !se.support.pixelPosition && se.fn.position && se.each(["top", "left"], function(e, n) {
            se.cssHooks[n] = {
                get: function(e, r) {
                    return r ? (r = st(e, n),
                    mt.test(r) ? se(e).position()[n] + "px" : r) : t
                }
            }
        })
    }),
    ...
    ;
    var At, jt, Dt = se.now(), Lt = /\?/, Ht = /#.*$/, Mt = /([?&])_=[^&]*/, qt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, _t = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ft = /^(?:GET|HEAD)$/, Ot = /^\/\//, Bt = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Pt = se.fn.load, Rt = {}, Wt = {}, $t = "*/".concat("*");
    try {
        jt = Y.href
    } catch (It) {
    ...
    se.extend({
        ...
        ajax: function(e, n) {
            ...
            e = t),
            n = n || {};
            var i, o, a, s, u, l, c, f, p = se.ajaxSetup({}, n), d = p.context || p, h = p.context && (d.nodeType || d.jquery) ? se(d) : se.event, g = se.Deferred(), m = se.Callbacks("once memory"), y = p.statusCode || {}, v = {}, b = {}, x = 0, T = "canceled", w = {
                readyState: 0,
            ...
            w.success = w.done,
            w.error = w.fail,
            p.url = ((e || p.url || jt) + "").replace(Ht, "").replace(Ot, At[1] + "//"),
            p.type = n.method || n.type || p.method || p.type,
            p.dataTypes = se.trim(p.dataType || "*").toLowerCase().match(le) || [""],
            null == p.crossDomain && (l = Bt.exec(p.url.toLowerCase()),
            p.crossDomain = !(!l || l[1] === At[1] && l[2] === At[2] && (l[3] || ("http:" === l[1] ? 80 : 443)) == (At[3] || ("http:" === At[1] ? 80 : 443)))),
            ...
            delete p.data),
            p.cache === !1 && (p.url = Mt.test(o) ? o.replace(Mt, "$1_=" + Dt++) : o + (Lt.test(o) ? "&" : "?") + "_=" + Dt++)),
            p.ifModified && (se.lastModified[o] && w.setRequestHeader("If-Modified-Since", se.lastModified[o]),
            se.etag[o] && w.setRequestHeader("If-None-Match", se.etag[o])),
    ...
    se.ajaxPrefilter("json jsonp", function(n, r, i) {
        ...
        return u || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = se.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback,
        u ? n[u] = n[u].replace(Xt, "$1" + o) : n.jsonp !== !1 && (n.url += (Lt.test(n.url) ? "&" : "?") + n.jsonp + "=" + o),
    ...
    var Gt, Qt, Kt = /^(?:toggle|show|hide)$/, Zt = RegExp("^(?:([+-])=|)(" + ue + ")([a-z%]*)$", "i"), en = /queueHooks$/, tn = [W], nn = {
        "*": [function(e, t) {
            var n, r, i = this.createTween(e, t), o = Zt.exec(t), a = i.cur(), s = +a || 0, u = 1, l = 20;
            if (o) {
                if (n = +o[2],
                r = o[3] || (se.cssNumber[e] ? "" : "px"),
                "px" !== r && s) {
    ...
    $.propHooks = {
        _default: {
            get: function(e) {
                var t;
                return null == e.elem[e.prop] || e.elem.style && null != e.elem.style[e.prop] ? (t = se.css(e.elem, e.prop, "auto"),
    ...
    se.fn.offset = function(e) {
        ...
        se.contains(n, o) ? (o.getBoundingClientRect !== t && (i = o.getBoundingClientRect()),
        r = z(a),
        {
    ...
    se.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || V.documentElement; e && !se.nodeName(e, "html") && "static" === se.css(e, "position"); )
                    e = e.offsetParent;
    ...
    se.each({
        ...
        se.fn[e] = function(i) {
            return se.access(this, function(e, i, o) {
                var a = z(e);
                return o === t ? a ? n in a ? a[n] : a.document.documentElement[i] : e[i] : (a ? a.scrollTo(r ? se(a).scrollLeft() : o, r ? o : se(a).scrollTop()) : e[i] = o,
                t)
